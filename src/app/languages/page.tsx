...
export const metadata: Metadata = {
  title: "Supported Languages - OCR Language List | image2word.com",
  description: "See all supported OCR languages for our image-to-text converter, including English, Chinese, Japanese, Korean, and more.",
  keywords: "OCR languages, supported languages, image to text languages, OCR language list, multilingual OCR",
  openGraph: {
    title: "Supported Languages - OCR Language List",
    description: "See all supported OCR languages for our image-to-text converter.",
    url: "https://image2word.com/languages",
  },
  alternates: {
    canonical: "https://image2word.com/languages",
  },
};
